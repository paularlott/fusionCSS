 ...
 * @link http://fusionCSS.com
 */
jQuery((function(){$("#viewSlideInMenu").length&&($("body").append('<div id="slideInMenuOverlay"></div>'),$("#slideInMenu").length||($("body").append('<div id="slideInMenu" role="menu"></div>'),$(".slideInMenu").each((function(a){var e="",t="";"ul"==this.nodeName.toLowerCase()&&(e="<ul>",t="</ul>"),$(this).hasClass("slideInMenuRootOnly")?($("#slideInMenuOverlay").html(e+$(this).html()+t).find("li ul").remove(),$("#slideInMenu").append($("#slideInMenuOverlay").html())):$("#slideInMenu").append(e+$(this).html()+t)}))),$("#slideInMenu").attr("aria-hidden",!0).addClass("slideInMenuLoaded"),$("body").on("click",(function(a){var e=$(a.target);!e.closest("#closeSlideInMenu").length&&(e.closest("#slideInMenu").length||e.closest("#viewSlideInMenu").length||e.closest(".slideInMenuOpener").length)||($("#slideInMenu").removeClass("slideInMenuShow").attr("aria-hidden",!0),$("#slideInMenuOverlay").removeClass("slideInMenuShow"),$("body").removeClass("disableScroll").removeClass("slideInMenuOpen"))})),$("#viewSlideInMenu").on("click",(function(a){$("#slideInMenuOverlay").addClass("slideInMenuShow"),$("#slideInMenu").addClass("slideInMenuShow").attr("aria-hidden",!1),$("body").addClass("disableScroll").addClass("slideInMenuOpen")})))})),a=0,$.fn.tabWidget=function(e){var t,s,l={},n=this,i=n.find(".tabs").first(),r=a++,o="1"===n.attr("data-tabs-save-active");if("1"!==n.attr("data-tabs-enabled")){if(n.attr("data-tabs-enabled","1"),"1"===n.attr("data-tabs-hide-wrap")){i.append('<li role="menubar" class="tabsMenu">&nbsp;<ul style="display: none"></ul></li>');var d=i.find(".tabsMenu"),c=d.find("ul");function h(){var a=i.width(),e=0;e+=d.width()+parseInt(d.css("margin-left"))+parseInt(d.css("margin-right"))+parseInt(d.css("padding-left"))+parseInt(d.css("padding-right")),i.find("li").show(),c.find("li").hide();var t=c.find("li"),s=0;i.find("li").each((function(l){var n=$(this);"tab"===n.attr("role")&&(e+=n.width()+parseInt(n.css("margin-left"))+parseInt(n.css("margin-right"))+parseInt(n.css("padding-left"))+parseInt(n.css("padding-right")))>=a&&($(this).hide(),t.eq(l).show(),s++)})),s?d.show():(d.hide(),c.hide())}i.find("li").each((function(){var a=$(this);if("tab"===a.attr("role")){var e,t=a[0].cloneNode(!0);null==(e=t.getAttribute("data-tabpanel"))&&(e=$(t).find("a").attr("href").replace(/^.*#/,"")),t.setAttribute("role","menuitem"),t.setAttribute("data-tab-name",e),c[0].appendChild(t)}})),$(window).on("resize",h),h(),d.on("click",(function(){"block"===c.css("display")?c.hide():c.show()})),$("body").on("click",(function(a){$(a.target).closest(".tabsMenu").length||c.hide()}))}if(null!=(s=this.attr("data-tabs-active"))&&(t=s),o){var f=JSON.parse(sessionStorage.getItem("flTabsState"));null!==f&&f.href===window.location.href?f.active[r]&&(t=f.active[r]):sessionStorage.removeItem("flTabsState")}i.find("li").each((function(){var a,s,n=$(this);"tab"===n.attr("role")&&(null==(a=n.attr("data-tabpanel"))&&(a=n.find("a").attr("href").replace(/^.*#/,"")),s=$("#"+a),(void 0===t||void 0!==e&&e===a)&&(t=a),a!==t?s.addClass("tabhidepanel").attr("aria-expanded",!1):s.addClass("tabshowpanel").attr("aria-expanded",!0),n.attr("aria-selected",!1),l[a]=[n,s],n.attr("data-tab-name",a))})),i.find("li").on("click",(function(a){var e=$(a.target).closest("li").attr("data-tab-name");if(e){if(l[t][1].addClass("tabhidepanel").removeClass("tabshowpanel").attr("aria-expanded",!1),l[e][1].removeClass("tabhidepanel").addClass("tabshowpanel").attr("aria-expanded",!0),l[t][0].removeClass("active").attr("aria-selected",!1),l[e][0].addClass("active").attr("aria-selected",!0),t=e,i.find(".tabsMenu ul").hide(),i.trigger("fcss:tabclick",{tabName:e}),o){var s=JSON.parse(sessionStorage.getItem("flTabsState"));s&&s.href===window.location.href||(s={href:window.location.href,active:[]}),s.active[r]=e,sessionStorage.setItem("flTabsState",JSON.stringify(s))}return a.preventDefault(),a.stopPropagation(),!1}})),void 0!==t&&(l[t][0].addClass("active").attr("aria-selected",!0),l[t][1].removeClass("tabhidepanel").addClass("tabshowpanel").attr("aria-expanded",!0));var u=n.closest("form");if(u.length){function p(){for(var a in l)if(l[a][1].find(".validation").hasClass("failed")){l[a][0].trigger("click");var e=$("label.validationError").first().attr("for");setTimeout((function(){$("#"+e).focus()}),100);break}}u.on("formValidationFailed",p).addClass("tabwidgetcontainer"),p()}}return n},jQuery((function(){$(".tabwidget").each((function(){$(this).tabWidget()}))})),
/**
